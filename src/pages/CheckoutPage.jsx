...
export default function CheckoutPage() {
  ...
  return (
    <section className="min-h-[calc(100vh-64px)] py-8 md:py-14"><div className="container-page max-w-5xl">
      <Link to={`/evento/${event.id ?? event.slug}`} className="mb-8 flex w-fit items-center gap-2 font-mono text-[10px] font-bold uppercase text-muted hover:text-strobe"><Icon name="back" size={16}/> Volver</Link>
